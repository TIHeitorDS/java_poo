...
public class Desenho {
    ...
    public Desenho(FiguraGeometrica figuraGeometrica1, FiguraGeometrica figuraGeometrica2, double coordenadaX1,
            double coordenadaY1, double coordenadaX2, double coordenadaY2) {
