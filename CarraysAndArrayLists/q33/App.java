...
public class App {
    public static void main(String[] args) {
        ...
        //EntradaEmAgenda compromisso5 = new EntradaEmAgenda("19:30", 19, 12, 2024, "Jantar sozinho");

        //agenda.novoCompromisso(compromisso1);
        //agenda.novoCompromisso(compromisso2);
        //agenda.novoCompromisso(compromisso3);
        //agenda.novoCompromisso(compromisso4);
        //agenda.novoCompromisso(compromisso5);
